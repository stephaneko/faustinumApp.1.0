...
<div class="card uper">
  ...
  <div class="card-body">
    ...
    @endif
      <form method="post" action="{{ route('apotres.update', $apotre->id) }}">
        @method('PATCH')
        @csrf
        <div class="form-group">
          <label for="name">Noms:</label>
          <input type="text" class="form-control" name="apotre_name" value={{ $apotre->apotre_name }} />
        </div>
         <div class="form-group">
          <label for="surname">Prenoms:</label>
          <input type="text" class="form-control" name="apotre_surname" value={{ $apotre->apotre_surname }} />
        </div>
        <div class="form-group">
              <label for="dateNais">Date de naissance:</label>
              <input type="date" class="form-control" name="apotre_dateNais"  value={{ $apotre->apotre_dateNais }} />
          </div>
          <div class="form-group">
